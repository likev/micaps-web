// visibility-level-step.test.js - Station Config Drawer HTML Layout (Review 1 Fix) + Derived Contour Visibility Persistence & Level Step Invariance (Review 2 Fixes)
